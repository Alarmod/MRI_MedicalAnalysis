...
struct qt_meta_stringdata_AspectRatioPixmapLabel_t {
    QByteArrayData data[5];
    char stringdata0[60];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AspectRatioPixmapLabel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AspectRatioPixmapLabel_t qt_meta_stringdata_AspectRatioPixmapLabel = {
    {
QT_MOC_LITERAL(0, 0, 22), // "AspectRatioPixmapLabel"
QT_MOC_LITERAL(1, 23, 9), // "setPixmap"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 11), // "resizeEvent"
QT_MOC_LITERAL(4, 46, 13) // "QResizeEvent*"

    },
    "AspectRatioPixmapLabel\0setPixmap\0\0"
...
void AspectRatioPixmapLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AspectRatioPixmapLabel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AspectRatioPixmapLabel::staticMetaObject = { {
    &QLabel::staticMetaObject,
    qt_meta_stringdata_AspectRatioPixmapLabel.data,
    qt_meta_data_AspectRatioPixmapLabel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AspectRatioPixmapLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AspectRatioPixmapLabel.stringdata0))
