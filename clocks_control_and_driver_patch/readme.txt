...
5. Every time if You want to use the video card to work with the library, run corresponding bat-file for Your GPU or create similar bat-file with optimal for You customizations.
These settings (locked by rigel.exe) remain in effect until you restart Your computer.
