...
- C++-модуль для высокоскоростной сегментации и классификации, основанный на архитектуре [Yolo 8](https://github.com/ultralytics/ultralytics/blob/main/docs/en/models/yolov8.md) и библиотеке [ONNXRuntime](https://onnxruntime.ai/) (поддерживаются CPU и GPU);
